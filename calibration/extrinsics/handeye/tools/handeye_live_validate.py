...
def main():
    ...
    parser.add_argument('--handeye', default=str(PROJECT_ROOT / 'calibration/extrinsics/handeye/sessions/handeye_samples/handeye_result_gt20_no32.yaml'))
    ...
    parser.add_argument('--output', default=str(PROJECT_ROOT / 'calibration/extrinsics/handeye/sessions/handeye_samples/live_validation.jsonl'))
