...
session_dir="/home/z/Apps-my/handeye_sessions/$(date +%Y%m%d_%H%M%S)"
mkdir -p "${session_dir}"
ln -sfn "${session_dir}" /home/z/Apps-my/handeye_sessions/latest

echo "New hand-eye session: ${session_dir}"
echo "Only captures with at least 21 ChArUco corners will be accepted."

exec python3 /home/z/Apps-my/handeye_capture.py \
